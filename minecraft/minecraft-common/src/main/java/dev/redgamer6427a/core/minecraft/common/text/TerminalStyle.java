...
public enum TerminalStyle {
     ...
     */
    TerminalStyle(String representation, int clashGroup){
    ...
    /**
     * Converts a 0xRRGGBB color to an ANSI escape code for the console.
     *
     * @param hexColor Color in 0xRRGGBB format
     * @return ANSI escape string to set foreground color
     */
    public static String hexToAnsi(int hexColor) {
