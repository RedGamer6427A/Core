...
public class GlobalDeopCommand extends BrigadierCommand {

    public GlobalDeopCommand() {
        super("globaldeop", "deops a player on every server", "gdeop");
        ...
        }, AllowedSources.PLAYER, playerArg);
    }
