...
import dev.redgamer6427a.core.minecraft.paper.testing.messaging.ProxyExecuteCommandPacket;

public class GlobalProxyExecute extends BrigadierCommand {
    public GlobalProxyExecute() {
        super("globalproxyexecute");
        ...
        addSyntax(context -> {
            ...
            new ProxyExecuteCommandPacket(string).send();
