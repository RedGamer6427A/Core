    ...
    public SubCommand() {
        ...
        setDefaultExecutor(context -> {
            ...
            if (context.getSource().getSender() instanceof Player player) {
                ...
                player.sendMessage(AdventureMM.cc("<green>Minimessage: <gray>").append(Component.text(minimessage)));
                Component component = AdventureMM.cc(minimessage);
                answer(context, AdventureMM.cc("<blue>Component: ").append(component));
                player.sendMessage(AdventureMM.cc("<pink>Parsed Minimessage: <gray>").append(Component.text(AdventureMM.serialize(component))));
